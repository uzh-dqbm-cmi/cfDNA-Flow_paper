...
```{r}
file_features <- list(
  "Fig2-3_coverage.csv" = "correlation_to_healthy",
  "Fig2-3_fragment_lengths.csv" = "globlen_mean",
  "Fig2-3_freia.csv" = "FrEIA_score",
  "Fig2-3_ichorCNA.csv" = "Tumor.Fraction",
  "Fig2-3_liq_hemato.csv" = "Dip depth: z-score vs controls in same region set",
  "Fig2-3_liq_saec.csv" = "Dip depth: z-score vs controls in same region set",
  "Fig2-3_tMAD.csv" = "tmad_vs_control"
)
...
filered01 <- list(
  "Fig4_red01/fragment_lengths.csv" = "globlen_mean",
  "Fig4_red01/FrEIA.csv" = "FrEIA_score",
  "Fig4_red01/ichorCNA.csv" = "Tumor.Fraction",
  "Fig4_red01/liq_hemato.csv" = "dip_depth",
  "Fig4_red01/liq_saec.csv" = "dip_depth",
  "Fig4_red01/tMAD.csv" = "tMAD_vs_control"
)
...
filered1 <- list(
  "Fig4_red1/fragment_lengths.csv" = "globlen_mean",
  "Fig4_red1/FrEIA.csv" = "FrEIA_score",
  "Fig4_red1/ichorCNA.csv" = "Tumor.Fraction",
  "Fig4_red1/liq_hemato.csv" = "dip_depth",
  "Fig4_red1/liq_saec.csv" = "dip_depth",
  "Fig4_red1/tMAD.csv" = "tMAD_vs_control"
)
...
fileszsel <- list(
  "Fig4_szsel/fragment_lengths.csv" = "globlen_mean",
  "Fig4_szsel/FrEIA.csv" = "FrEIA_score",
  "Fig4_szsel/ichorCNA.csv" = "Tumor.Fraction",
  "Fig4_szsel/tMAD.csv" = "tMAD_vs_control"
)
...
```{r}
counts_summary <- read_csv(file.path(wdir, "SFig1_counts_summary.csv"))
...
average_fragment_length <- read_csv("data/SFig1_average_fragment_length.csv")
...
df_summary <- read_csv("data/SFig1_discarded_reads.csv")
...
runtimes_cumsum <- read_csv(file.path(wdir, "SFig7_runtimes.csv"))
